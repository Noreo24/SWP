                                ...
                                <div class="products-tabs">
                                    ...
                                    <div id="tab6" class="tab-pane active">
                                        <div class="products-slick" data-nav="#slick-nav-6">
                                            ...
                                            <c:forEach var="iteam" items="${brands}">
                                                <div class="product">
                                                    ...
                                                    <div class="product-body">
                                                        <p class="product-category">${iteam.name}</p>
...
<!--                                                        <div class="product-btns">
                                                    ...
                                                    <div class="add-to-cart">
                                                        <a href="${pageContext.request.contextPath}/BrandDetail?idBrand=${iteam.id}"><button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> View More</button></a> 
                                                    </div>
                                                </div>
                                            </c:forEach>
                                            <!-- /product -->
