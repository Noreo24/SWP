    ...
    <body>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="breadcrumb-tree">
                            ...
                            <li><a href="listProduct">All Categories</a></li>
                            ...
                            <c:forEach items="${allCategories}" var="c">
                                <div>
                                    <c:if test="${c.categoryId == 1}">
                                        <input onchange="listProductByCate(this)" type="radio" class="form-check-input" id="${c.categoryId}" value="${c.categoryId}" name="materialExampleRadios">
                                        <label class="form-check-label small card-link-secondary" style="font-weight: normal;" for="${c.categoryId}">${c.categoryName}</label>
                                ...
                                <div class="product-widget">
                                    <div class="product-img">
                                        <c:forEach items="${allImages}" var="aI">
                                            <c:if test="${p.product_id == aI.productId}">
                                                <!--<a href="productDetail?pid=${p.product_id}">-->
                                    ...
                                    <div class="product-body">
                                        <c:forEach items="${allCategories}" var="c">
                                            <c:if test="${p.category_id == c.categoryId}">
                            ...
                            <c:forEach items="${list_6_product}" var="ap">
                                <div class="col-md-4 col-xs-6">
                                    <div class="product">
                                        <div class="product-img">
                                            <c:forEach items="${allImages}" var="aI">
                                                <c:if test="${ap.product_id == aI.productId}">
                                                    <img src="${aI.images}" alt="">
                                                </c:if>
                                            </c:forEach>
                                            <c:if test="${ap.sale == 1}">
        ...
        <script>
                                        ...
                                        function listProductByCate(type) {
                                            ...
                                            $.ajax({
                                                url: "/Phone_Shop_Final_Final/listProductByCateAjax?selectoption=" + encodeURIComponent(selectedOption),
                                        ...
                                        function listProductByBrand(type) {
                                            var selectedOption = type.value;
                                            $.ajax({
                                                url: "/Phone_Shop_Final_Final/listProductByBrandAjax?selectoption=" + encodeURIComponent(selectedOption),
                                                type: "get", //send it through get method
                                                data: {
                                        ...
                                        function sortByPrice(type) {
                                            ...
                                            var selectedOption = type.value;
                                            $.ajax({
                                                url: "/Phone_Shop_Final_Final/sortProductBySalePriceAscAjax?selectoption=" + encodeURIComponent(selectedOption),
                                                type: "get", //send it through get method
                                                data: {
                                        ...
                                        function sortByRate(type) {
                                            ...
                                            var selectedOption = type.value;
                                            $.ajax({
                                                url: "/Phone_Shop_Final_Final/sortProductByRateStarAjax?selectoption=" + encodeURIComponent(selectedOption),
                                                type: "get", //send it through get method
                                                data: {
                                        ...
                                        function searchByPriceMinToMax() {
                                            ...
                                            $.ajax({
                                                url: "/Phone_Shop_Final_Final/searchAjaxPriceMinToMax",
                                                type: "get", //send it through get method
                                                data: {
                                                    priceMin: numMin,
                                                    priceMax: numMax
                                        ...
                                        function searchByName(param) {
                                            ...
                                            $.ajax({
                                                url: "/Phone_Shop_Final_Final/searchByNameAjax",
                                                type: "get", //send it through get method
                                                data: {
                                                    txt: txtSearch
                                                },
