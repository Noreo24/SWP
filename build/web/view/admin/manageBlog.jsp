                ...
                <div class="row">
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <a href="${pageContext.request.contextPath}/addblog"><button type="button" class="btn btn-success">Add New Blog</button></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <c:forEach items="${bloglist}" var="blog">
                                <tr>
                                    <th scope="row">${blog.getBlog_id()}</th>
                                    <td><img src="${blog.getThumbnail()}" style="width: 150px"></td>
                                    <td>${blog.getTitle()}</td>
...
<<<<<<< HEAD:build/web/view/admin/manageBlog.jsp
                                        <div style="display: flex; justify-content: space-around;">
                                            ...
                                            <a href=""> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-slash-fill" viewBox="0 0 16 16">
                    ...
                    <ul class="store-pagination">
                        <c:forEach begin="1" end="${endPage}" var="i">
                            <li class="page-item ${index == i ? 'active' : ''}">
                                <a href="${pageContext.request.contextPath}/bloglistmanage?index=${i}">${i}</a>
                            </li>
                        </c:forEach>
...
>>>>>>> 51d25809906605ac8e4ce6aa7ab5edf1d3e40558:web/view/admin/ManagerAccount.jsp
                ...
                <a href="${pageContext.request.contextPath}/view/admin/adminMenu.jsp"><button type="button" class="btn btn-primary">Back to home</button></a>
            </div>
            <!-- /container -->
        </div>
        <!-- /SECTION -->
