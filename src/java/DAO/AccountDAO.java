...
//        System.out.println(new AccountDAO().getAll("", 1, 2));
    ...
    public ArrayList<Account> getAll(String name, int pageNumber, int pageSize, int roleSelect) {
    ...
    public int getCount(String name, int roleSelect) {
        ArrayList<Account> accounts = new ArrayList<>();
