...
public class ManagerAddBrandController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.getAttribute("acc") != null) {
            ...
            request.setAttribute("checkActive", "Manage Add Brand");

            request.getRequestDispatcher("/view/admin/ManagerAddBrand.jsp").forward(request, response);
        } else {
...
//            trademark.setImg(request.getParameter("txtImg"));
            ...
            int idTra = new trademarkDAO().add(trademark);

            trademark = new trademarkDAO().getTrademarkByID(idTra);
