...
public class OrderDetailController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            request.setAttribute("orderdetails", new OrderDetailDAO().getOrderDetailByOrderID(id));
            
            request.getRequestDispatcher("view/common/order-detail.jsp").forward(request, response);
