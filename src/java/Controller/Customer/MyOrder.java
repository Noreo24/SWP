...
public class MyOrder extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            request.setAttribute("orders", new OrderDAO2().getOrdersByUserId(account.getUserID()));
        } catch (Exception ex) {
            Logger.getLogger(MyOrder.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        request.getRequestDispatcher("view/common/myOrder.jsp").forward(request, response);
