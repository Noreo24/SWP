 ...
 * @author Admin
 */
@WebServlet(name = "listProductByCateAjax", urlPatterns = {"/listProductByCateAjax"})
public class listProductByCateAjax extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> listProductByCate = pDAO.listProductByCate(selectedOption);
        List<productImage> allImages = piDAO.getAllImage();

        for (Product i : listProductByCate) {
        ...
        for (Product o : listProductByCate) {
