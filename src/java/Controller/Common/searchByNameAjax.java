 ...
 * @author Admin
 */
@WebServlet(name = "searchByNameAjax", urlPatterns = {"/searchByNameAjax"})
public class searchByNameAjax extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String txtSearch = "";
        String txtSearchOrigin = request.getParameter("txt").trim();
        // Validate txt search
        for (char currentChar : txtSearchOrigin.toCharArray()) {
            if (Character.isLetterOrDigit(currentChar)) {
                txtSearch = txtSearch + currentChar;
            } else {
                txtSearch = txtSearchOrigin;
            }
        }
        ...
        List<Product> searchByName = pDAO.searchByName(txtSearch);
        List<productImage> allImages = piDAO.getAllImage();

        for (Product i : searchByName) {
