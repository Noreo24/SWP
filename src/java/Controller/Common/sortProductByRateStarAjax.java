 ...
 * @author Admin
 */
@WebServlet(name = "sortProductByRateStarAjax", urlPatterns = {"/sortProductByRateStarAjax"})
public class sortProductByRateStarAjax extends HttpServlet {
...
//        response.sendRedirect("/view/user/store.jsp");

        for (Product i : sortProductByRateStar) {
