 ...
 * @author Admin
 */
@WebServlet(name = "listProductByBrandAjax", urlPatterns = {"/listProductByBrandAjax"})
public class listProductByBrandAjax extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> listProductByBrand = pDAO.listProductByBrand(selectedOption);
        List<productImage> allImages = piDAO.getAllImage();

        for (Product i : listProductByBrand) {
        ...
        for (Product o : listProductByBrand) {
